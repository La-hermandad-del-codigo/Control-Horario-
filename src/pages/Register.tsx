...
// useAuth: hook de autenticación con función signUp y signInWithGoogle.
...
export default function Register() {
    ...
    // Extrae las funciones signUp y signInWithGoogle del hook de autenticación.
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            console.error(err);
            setError(err.message || 'Ocurrió un error al registrarse con Google');
            ...
            <div className="glass-card w-full max-w-md p-8 md:p-10 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <span className="text-gray-500 text-sm">o regístrate con email</span>
                        <div className="flex-1 h-px bg-white/10"></div>
                    </div>
